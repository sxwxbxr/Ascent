...
**Bekanntes Beta-Problem (20.07., Gerätetest 2):** Update-Installation über die Vorversion → Crash direkt beim Öffnen; erst Deinstallation+Neuinstallation half. Ursache unklar (Altdaten-Inkompatibilität, Signatur war ok — Installation lief durch). Massnahme für M7: Boot-Guard mit "App-Daten zurücksetzen"-Option (DB+SecureStore löschen, Server-Daten kommen per Sync zurück), damit nie wieder deinstalliert werden muss; bei nächstem Auftreten: `adb logcat`-Auszug sichern.
